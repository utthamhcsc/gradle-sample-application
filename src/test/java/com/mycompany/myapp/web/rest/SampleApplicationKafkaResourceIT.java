...
class SampleApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        SampleApplicationKafkaResource kafkaResource = new SampleApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/sample-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/sample-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
