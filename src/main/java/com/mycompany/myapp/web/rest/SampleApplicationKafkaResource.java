...
@RestController
@RequestMapping("/api/sample-application-kafka")
public class SampleApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SampleApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SampleApplicationKafkaResource(KafkaProperties kafkaProperties) {
